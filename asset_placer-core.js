...
window.I18N = {
    ...
    translations: {
        en: {
            ...
            importTerrain: "🌄 Terrain (.bloxdschem)",
            importTerrainTitle: "Load a .bloxdschem as the ground. A Minecraft .schem must go through Schem Converter first.",
            terrainImportSuccess: "Terrain imported:",
            terrainImportError: "Terrain import failed:",
            export: "📤 Export for Bloxd",
            exportTitle: "Downloads a .bloxdschem for the game (or a .zip if the scene is too big). Not a .json.",
            formatHint: ".bloxdschem = game file · .json = session save (Bloxd cannot load it) · Minecraft .schem → Schem Converter first",
            settings: "⚙ Settings",
            ...
            exportScene: "Save session (.json) — not for the game",
            importScene: "Resume a session (.json)",
            ...
            exportModalDesc: "You get a .bloxdschem for Bloxd. If the scene is too big, it becomes a .zip of parts — load each part in game at the same Y. The session .json is a different button, and Bloxd cannot load it.",
        ...
        fr: {
            ...
            importTerrain: "🌄 Terrain (.bloxdschem)",
            importTerrainTitle: "Charge un .bloxdschem comme sol. Un .schem Minecraft doit d'abord passer par Schem Converter.",
            terrainImportSuccess: "Terrain importé :",
            terrainImportError: "Échec de l'import du terrain :",
            export: "📤 Exporter pour Bloxd",
            exportTitle: "Télécharge un .bloxdschem pour le jeu (ou un .zip si la scène est trop grande). Pas un .json.",
            formatHint: ".bloxdschem = fichier de jeu · .json = sauvegarde de session (Bloxd ne le charge pas) · .schem Minecraft → Schem Converter d'abord",
            settings: "⚙ Paramètres",
            ...
            exportScene: "Sauver la session (.json) — pas pour le jeu",
            importScene: "Reprendre une session (.json)",
            ...
            exportModalDesc: "Tu obtiens un .bloxdschem pour Bloxd. Si la scène est trop grande, c'est un .zip de parties — charge chaque partie en jeu au même Y. Le .json de session est un autre bouton, Bloxd ne le charge pas.",
        ...
        ja: {
            library:"📚 アセットライブラリ",importTerrain:"🌄 地形 (.bloxdschem)",
            importTerrainTitle:"地面として .bloxdschem を読み込みます。Minecraft の .schem は先に Schem Converter。",
            terrainImportSuccess:"地形インポート成功:",terrainImportError:"地形インポート失敗:",
            export:"📤 Bloxd用に書き出し",exportTitle:"ゲーム用 .bloxdschem（大きすぎると .zip）。.json ではありません。",
            formatHint:".bloxdschem = ゲーム用 · .json = セッション保存（Bloxdは読めない）· Minecraft の .schem は先に Converter",
            settings:"⚙ 設定",properties:"プロパティ",
            ...
            exportScene:"セッション保存 (.json) — ゲーム用ではない",importScene:"セッションを再開 (.json)",
            exportModalTitle:"📤 スケマを書き出し",
            exportModalDesc:"Bloxd用の .bloxdschem をダウンロード。大きすぎるとパーツの .zip。ゲームでは同じYで読み込みます。.json は別ボタンで、Bloxdは読めません。",
            exportConfirmBtn:"⬇️ .bloxdschem をダウンロード",
        ...
        ko: {
            library:"📚 에셋 라이브러리",importTerrain:"🌄 지형 (.bloxdschem)",
            importTerrainTitle:"바닥으로 .bloxdschem을 불러옵니다. 마인크래프트 .schem은 먼저 Schem Converter.",
            terrainImportSuccess:"지형 가져오기 성공:",terrainImportError:"지형 가져오기 실패:",
            export:"📤 Bloxd용 내보내기",exportTitle:"게임용 .bloxdschem (너무 크면 .zip). .json이 아닙니다.",
            formatHint:".bloxdschem = 게임 파일 · .json = 세션 저장 (Bloxd는 못 읽음) · 마인크래프트 .schem → 먼저 Converter",
            settings:"⚙ 설정",properties:"속성",
            ...
            exportScene:"세션 저장 (.json) — 게임용 아님",importScene:"세션 이어하기 (.json)",
            exportModalTitle:"📤 스케매 내보내기",
            exportModalDesc:"Bloxd용 .bloxdschem을 받습니다. 너무 크면 파트의 .zip. 게임에서는 같은 Y로 불러오세요. .json은 다른 버튼이며 Bloxd가 읽지 못합니다.",
            exportConfirmBtn:"⬇️ .bloxdschem 다운로드",
        ...
        th: {
            library:"📚 ไลบรารีอุปกรณ์",importTerrain:"🌄 ภูมิประเทศ (.bloxdschem)",
            importTerrainTitle:"โหลด .bloxdschem เป็นพื้น ไฟล์ .schem ของ Minecraft ต้องผ่าน Schem Converter ก่อน",
            terrainImportSuccess:"นำเข้าภูมิประเทศสำเร็จ:",terrainImportError:"นำเข้าภูมิประเทศล้มเหลว:",
            export:"📤 ส่งออกสำหรับ Bloxd",exportTitle:"ได้ .bloxdschem สำหรับเกม (ใหญ่เกินเป็น .zip) ไม่ใช่ .json",
            formatHint:".bloxdschem = ไฟล์เกม · .json = เซฟเซสชัน (Bloxd โหลดไม่ได้) · .schem ของ Minecraft → Converter ก่อน",
            settings:"⚙ ตั้งค่า",properties:"คุณสมบัติ",
            ...
            exportScene:"บันทึกเซสชัน (.json) — ไม่ใช่ไฟล์เกม",importScene:"เปิดเซสชันต่อ (.json)",
            exportModalTitle:"📤 ส่งออกสเคมา",
            exportModalDesc:"ได้ .bloxdschem สำหรับ Bloxd ใหญ่เกินจะเป็น .zip ของชิ้นส่วน โหลดในเกมที่ความสูง Y เดิม .json เป็นปุ่มอีกปุ่ม Bloxd โหลดไม่ได้",
            exportConfirmBtn:"⬇️ ดาวน์โหลด .bloxdschem",
