...
const I18N = {
    fr: {
        ...
        footer: "Bloxd Tools v6.9.0 — Langue et clavier partagés entre tous les éditeurs via le menu",
    ...
    en: {
        ...
        footer: "Bloxd Tools v6.9.0 — Language and keyboard shared across all editors via the",
    ...
    ja: {
        ...
        footer: "Bloxd Tools v6.9.0 — すべてのエディタで言語・キーボード共有",
    ...
    ko: {
        ...
        footer: "Bloxd Tools v6.9.0 — 모든 에디터에서 언어·키보드 공유",
    ...
    th: {
        ...
        footer: "Bloxd Tools v6.9.0 — แชร์ภาษาและคีย์บอร์ดระหว่างเครื่องมือทั้งหมด",
